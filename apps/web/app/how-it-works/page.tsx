  ...
  return (
    ...
    >
      <p className="mb-8 text-sm leading-6 text-zinc-400">
        Everything you need to know about how FilmSnaps sources content, blocks
        ads, and protects your privacy — explained transparently.
      </p>
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <SectionItem value="streaming" title="How Streaming Works">
          <Body>
            When you press &quot;Watch&quot;, the app loads the provider&apos;s
            embed page inside a sandboxed WebView — a dedicated browser view
            that is isolated from the rest of the app. The WebView:
          </Body>
        ...
        <SectionItem value="adblock" title="Ad Blocking Technology">
          ...
          <SubSection title="Layer 2: Cosmetic Filtering">
            <Body>
              Some ads are injected by the page&apos;s own JavaScript and cannot
              be blocked at the network level. For these, the app injects CSS
              rules that hide ad containers, popup overlays, and banner elements
          ...
          <FaqItem
            ...
            answer={
              <Body>
                ...
                access to your device&apos;s storage, file system, contacts,
                apps, or any other personal data. It cannot execute code outside
                that WebView, cannot read app state, and cannot install anything
                on your device. The WebView is destroyed completely when you
                leave the player, leaving zero traces behind. All the provider
                sees is a standard HTTP request for their embed page — exactly
                what a normal browser would send. They have no way to reach into
          ...
          <FaqItem
            ...
            answer={
              <Body>
                ...
                region you&apos;re connecting from (usually the city level) and
                the name of your internet service provider. This is the same
          ...
          <FaqItem
            ...
            answer={
              <Body>
                ...
                page&apos;s own JavaScript after the page loads (same-origin).
                These require the DOM observer (Layer 3) to detect and remove
                them, which can take a few hundred milliseconds. You might see a
                flash of an ad container before it is removed. This is harmless
                and does not mean the ad was fully rendered or tracked.
              </Body>
            }
          />
          ...
          <FaqItem
            ...
            answer={
              <Body>
                ...
                uBlock Origin, and Brave Browser&apos;s built-in blocking). For
                more details, see the Legal &amp; DMCA page in Settings.
              </Body>
            }
          />
        </SectionItem>
