    ...
    >
      ...
      >
        ...
        <PSection title="Data Collection">
          <PBody>
            FilmSnaps does <PBold>not</PBold> collect, store, or transmit any
        ...
        <PSection title="How Data Is Stored">
          <PBody>
            All local data is stored using your device's internal storage and
            standard operating-system APIs (AsyncStorage and the file system).
            No data is encrypted beyond what the operating system provides by
            default. We recommend enabling device-level encryption in your
        ...
        <PSection title="Contact">
          <PBody>
            ...
            via email at privacy@filmsnaps.app.
          </PBody>
        </PSection>
      </ScrollView>
    </View>
