...
| [Security](security.md) | The full security stack: threat model, R0–R8 cascade, L2–L8 desktop layers, mobile native protection, `blocklist.json` config, audit diagnostics. |
...
| File | Contents |
| --- | --- |
| [`../CONTRIBUTING.md`](../CONTRIBUTING.md) | Setup, dev workflow, adding a provider, editing `blocklist.json`. |
